...
| **Priority** | P2 |
| **MVP** | No |
| **Dependencies** | R-802, TE-613 |

## Description

Intervention UI. See development plan roadmap.

## Objective

Teacher panel showing recommendations with one-click assign quiz.
...
- `See task — implement as needed for R-803`
...
```
You are a senior full-stack engineer implementing task R-803 for IqbalAI LMS.

Teacher panel showing recommendations with one-click assign quiz.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for R-803
