# R-805 — Auto-Assign Interventions
...
Auto-Assign Interventions. See development plan roadmap.

## Objective

Auto-create assignment from intervention recommendation.
...
- `See task — implement as needed for R-805`
...
```
You are a senior full-stack engineer implementing task R-805 for IqbalAI LMS.

Auto-create assignment from intervention recommendation.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for R-805
