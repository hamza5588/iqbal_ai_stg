# R-801 — Rule-Based Intervention Engine
...
| **Priority** | P2 |
| **MVP** | No |
| **Dependencies** | A-308, AN-701 |

## Description

Rule-Based Intervention Engine. See development plan roadmap.

## Objective

Recommend actions for struggling students: extra quiz, review topic, reassess.
...
- `See task — implement as needed for R-801`
...
```
You are a senior full-stack engineer implementing task R-801 for IqbalAI LMS.

Recommend actions for struggling students: extra quiz, review topic, reassess.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for R-801
