...
PDF Source Analytics. See development plan roadmap.

## Objective

Analytics comparing manual vs PDF-converted quiz effectiveness.
...
- `See task — implement as needed for AN-708`
...
```
You are a senior full-stack engineer implementing task AN-708 for IqbalAI LMS.

Analytics comparing manual vs PDF-converted quiz effectiveness.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for AN-708
