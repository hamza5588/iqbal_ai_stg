# AN-704 — Class Performance Report
...
Class Performance Report. See development plan roadmap.

## Objective

Class-wide topic mastery report.
...
- `See task — implement as needed for AN-704`
...
```
You are a senior full-stack engineer implementing task AN-704 for IqbalAI LMS.

Class-wide topic mastery report.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for AN-704
