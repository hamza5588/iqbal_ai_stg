...
Learning Insights UI. See development plan roadmap.

## Objective

Teacher dashboard insights cards with real aggregated data.
...
- `See task — implement as needed for AN-702`
...
```
You are a senior full-stack engineer implementing task AN-702 for IqbalAI LMS.

Teacher dashboard insights cards with real aggregated data.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for AN-702
