# AN-703 — Individual Student Report
...
Individual Student Report. See development plan roadmap.

## Objective

Generate PDF/HTML student performance report.
...
- `See task — implement as needed for AN-703`
...
```
You are a senior full-stack engineer implementing task AN-703 for IqbalAI LMS.

Generate PDF/HTML student performance report.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for AN-703
