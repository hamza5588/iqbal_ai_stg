# AN-701 — Class Topic Aggregation
...
| **Priority** | P2 |
| **MVP** | No |
| **Dependencies** | A-310, TE-603 |

## Description

Class Topic Aggregation. See development plan roadmap.

## Objective

Aggregate topic scores across class — e.
...
- Aggregate topic scores across class — e.g. 18/30 struggle with Fraction Word Problems.

## Files to Create

- `See task — implement as needed for AN-701`
...
```
You are a senior full-stack engineer implementing task AN-701 for IqbalAI LMS.

Aggregate topic scores across class — e.g. 18/30 struggle with Fraction Word Problems.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for AN-701
