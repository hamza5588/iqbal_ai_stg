# I-1006 — Dashboard Modularization
...
Dashboard Modularization. See development plan roadmap.

## Objective

Extract LMS sections from monolithic templates into partials/includes.
...
- `See task — implement as needed for I-1006`
...
```
You are a senior full-stack engineer implementing task I-1006 for IqbalAI LMS.

Extract LMS sections from monolithic templates into partials/includes.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1006
