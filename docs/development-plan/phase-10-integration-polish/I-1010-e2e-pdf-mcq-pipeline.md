...
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | A-325-A-332 |

## Description

E2E PDF→MCQ Pipeline. See development plan roadmap.

## Objective

Integration test: sample Q&A PDF text → extract → MCQ → validate 4 options.
...
- `See task — implement as needed for I-1010`
...
```
You are a senior full-stack engineer implementing task I-1010 for IqbalAI LMS.

Integration test: sample Q&A PDF text → extract → MCQ → validate 4 options.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1010
