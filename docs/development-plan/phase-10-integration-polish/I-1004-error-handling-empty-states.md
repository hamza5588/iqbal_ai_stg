# I-1004 — Error Handling & Empty States
...
Error Handling & Empty States. See development plan roadmap.

## Objective

Graceful UI for failed PDF parse, no class, no path, low confidence.
...
- `See task — implement as needed for I-1004`
...
```
You are a senior full-stack engineer implementing task I-1004 for IqbalAI LMS.

Graceful UI for failed PDF parse, no class, no path, low confidence.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1004
