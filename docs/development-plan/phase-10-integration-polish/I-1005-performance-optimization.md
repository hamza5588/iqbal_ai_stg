# I-1005 — Performance Optimization
...
Performance Optimization. See development plan roadmap.

## Objective

Index tuning, N+1 query fixes for LMS dashboards.
...
- `See task — implement as needed for I-1005`
...
```
You are a senior full-stack engineer implementing task I-1005 for IqbalAI LMS.

Index tuning, N+1 query fixes for LMS dashboards.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1005
