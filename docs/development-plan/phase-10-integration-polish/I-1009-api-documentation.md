...
API Documentation. See development plan roadmap.

## Objective

Document all /api/lms endpoints in API_REFERENCE.
...
- Document all /api/lms endpoints in API_REFERENCE.md.

## Files to Create

- `See task — implement as needed for I-1009`
...
```
You are a senior full-stack engineer implementing task I-1009 for IqbalAI LMS.

Document all /api/lms endpoints in API_REFERENCE.md.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1009
