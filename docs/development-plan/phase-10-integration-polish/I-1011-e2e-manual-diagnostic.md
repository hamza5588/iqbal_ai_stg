...
| **Priority** | P1 |
| **MVP** | No |
| **Dependencies** | A-301-A-307 |

## Description

E2E Manual Diagnostic. See development plan roadmap.

## Objective

E2E manual question bank → diagnostic → student flow.
...
- `See task — implement as needed for I-1011`
...
```
You are a senior full-stack engineer implementing task I-1011 for IqbalAI LMS.

E2E manual question bank → diagnostic → student flow.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1011
