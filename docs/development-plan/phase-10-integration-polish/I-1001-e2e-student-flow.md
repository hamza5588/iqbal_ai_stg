...
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | Phases 2-5 MVP |

## Description

E2E Student Flow Test. See development plan roadmap.

## Objective

pytest E2E: login → diagnostic → quiz → progress → learning path.
...
- `See task — implement as needed for I-1001`
...
```
You are a senior full-stack engineer implementing task I-1001 for IqbalAI LMS.

pytest E2E: login → diagnostic → quiz → progress → learning path.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1001
