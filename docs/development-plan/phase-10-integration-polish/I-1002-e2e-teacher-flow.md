...
E2E Teacher Flow Test. See development plan roadmap.

## Objective

pytest E2E: login → PDF upload → MCQ → assign → view results.
...
- `See task — implement as needed for I-1002`
...
```
You are a senior full-stack engineer implementing task I-1002 for IqbalAI LMS.

pytest E2E: login → PDF upload → MCQ → assign → view results.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for I-1002
