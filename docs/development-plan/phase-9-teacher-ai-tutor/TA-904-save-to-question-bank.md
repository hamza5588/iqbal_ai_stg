...
| **Priority** | P3 |
| **MVP** | No |
| **Dependencies** | TA-902, A-301 |

## Description

Save to Question Bank. See development plan roadmap.

## Objective

Export AI-generated questions from teacher tutor to question bank.
...
- `See task — implement as needed for TA-904`
...
```
You are a senior full-stack engineer implementing task TA-904 for IqbalAI LMS.

Export AI-generated questions from teacher tutor to question bank.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TA-904
