...
Teacher Tutor UI. See development plan roadmap.

## Objective

Dedicated teacher tutor chat widget on teacher dashboard.
...
- `See task — implement as needed for TA-903`
...
```
You are a senior full-stack engineer implementing task TA-903 for IqbalAI LMS.

Dedicated teacher tutor chat widget on teacher dashboard.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TA-903
