...
Teacher Tutor API. See development plan roadmap.

## Objective

POST /api/lms/teacher/tutor — separate from student tutor, no student PII.
...
- `See task — implement as needed for TA-902`
...
```
You are a senior full-stack engineer implementing task TA-902 for IqbalAI LMS.

POST /api/lms/teacher/tutor — separate from student tutor, no student PII.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TA-902
