# TA-901 — Teacher Tutor Prompt

| Field | Value |
|-------|-------|
| **Phase** | Phase 9 — Teacher AI Tutor |
...
Teacher Tutor Prompt. See development plan roadmap.

## Objective

Teacher-specific AI prompt for grade-appropriate explanations and practice question generation.
...
- `See task — implement as needed for TA-901`
...
```
You are a senior full-stack engineer implementing task TA-901 for IqbalAI LMS.

Teacher-specific AI prompt for grade-appropriate explanations and practice question generation.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TA-901
