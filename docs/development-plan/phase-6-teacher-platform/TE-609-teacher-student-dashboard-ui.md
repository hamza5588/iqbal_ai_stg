# TE-609 — Teacher Student Dashboard UI
...
Teacher Student Dashboard UI. See development plan roadmap.

## Objective

Per-student performance view: overall %, topic breakdown, struggling flags.
...
- `See task — implement as needed for TE-609`
...
```
You are a senior full-stack engineer implementing task TE-609 for IqbalAI LMS.

Per-student performance view: overall %, topic breakdown, struggling flags.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-609
