# TE-613 — Create Assignment

| Field | Value |
|-------|-------|
| **Phase** | Phase 6 — Teacher Platform |
| **Type** | Backend/Frontend/AI/Testing |
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | F-008, A-332, TE-601 |

## Description

Create Assignment. See development plan roadmap.

## Objective

Create Assignment flow: select/create quiz ONLY → pick class → due date → publish.
...
- Create Assignment flow: select/create quiz ONLY → pick class → due date → publish. One quiz per assignment.

## Files to Create

- `See task — implement as needed for TE-613`
...
```
You are a senior full-stack engineer implementing task TE-613 for IqbalAI LMS.

Create Assignment flow: select/create quiz ONLY → pick class → due date → publish. One quiz per assignment.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-613
