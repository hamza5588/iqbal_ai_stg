...
Class CRUD API. See development plan roadmap.

## Objective

Implement /api/lms/classes CRUD — create, list, update, archive.
...
- Implement /api/lms/classes CRUD — create, list, update, archive. Teacher scoped.

## Files to Create

- `See task — implement as needed for TE-601`
...
```
You are a senior full-stack engineer implementing task TE-601 for IqbalAI LMS.

Implement /api/lms/classes CRUD — create, list, update, archive. Teacher scoped.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-601
