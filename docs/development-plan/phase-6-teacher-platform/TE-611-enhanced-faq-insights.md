...
Enhanced FAQ Insights. See development plan roadmap.

## Objective

Bridge lesson FAQ to topic tags for class-level struggling insights.
...
- `See task — implement as needed for TE-611`
...
```
You are a senior full-stack engineer implementing task TE-611 for IqbalAI LMS.

Bridge lesson FAQ to topic tags for class-level struggling insights.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-611
