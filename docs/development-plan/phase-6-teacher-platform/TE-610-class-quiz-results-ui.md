...
Class Quiz Results UI. See development plan roadmap.

## Objective

Class-level assignment results: completion %, avg score, overdue list.
...
- `See task — implement as needed for TE-610`
...
```
You are a senior full-stack engineer implementing task TE-610 for IqbalAI LMS.

Class-level assignment results: completion %, avg score, overdue list.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-610
