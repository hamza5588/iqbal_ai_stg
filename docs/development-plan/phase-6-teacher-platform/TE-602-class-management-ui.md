...
Class Management UI. See development plan roadmap.

## Objective

Teacher dashboard class management section: create class, list classes, show join code.
...
- `See task — implement as needed for TE-602`
...
```
You are a senior full-stack engineer implementing task TE-602 for IqbalAI LMS.

Teacher dashboard class management section: create class, list classes, show join code.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-602
