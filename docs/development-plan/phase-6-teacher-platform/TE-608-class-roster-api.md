# TE-608 — Class Roster + Summary API
...
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | TE-603, A-310 |

## Description

Class Roster + Summary API. See development plan roadmap.

## Objective

GET /api/lms/classes/<id>/students with summary metrics per student.
...
- `See task — implement as needed for TE-608`
...
```
You are a senior full-stack engineer implementing task TE-608 for IqbalAI LMS.

GET /api/lms/classes/<id>/students with summary metrics per student.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-608
