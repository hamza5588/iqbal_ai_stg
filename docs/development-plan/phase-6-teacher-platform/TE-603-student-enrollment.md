...
Student Enrollment. See development plan roadmap.

## Objective

Enrollment management: add student, bulk import optional, join code display.
...
- `See task — implement as needed for TE-603`
...
```
You are a senior full-stack engineer implementing task TE-603 for IqbalAI LMS.

Enrollment management: add student, bulk import optional, join code display.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-603
