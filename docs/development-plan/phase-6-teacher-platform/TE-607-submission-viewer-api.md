...
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | A-304, TE-603 |

## Description

Submission Viewer API. See development plan roadmap.

## Objective

GET /api/lms/classes/<id>/assignments/<aid>/submissions — student scores and status.
...
- `See task — implement as needed for TE-607`
...
```
You are a senior full-stack engineer implementing task TE-607 for IqbalAI LMS.

GET /api/lms/classes/<id>/assignments/<aid>/submissions — student scores and status.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-607
