...
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | A-330, A-331 |

## Description

Quiz Creation Hub UI. See development plan roadmap.

## Objective

Teacher Quiz Creation Hub with tabs: PDF Q&A Auto (primary), Manual, Diagnostic PDF+Topics.
...
- `See task — implement as needed for TE-612`
...
```
You are a senior full-stack engineer implementing task TE-612 for IqbalAI LMS.

Teacher Quiz Creation Hub with tabs: PDF Q&A Auto (primary), Manual, Diagnostic PDF+Topics.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for TE-612
