# P-405 — Path Refresh on Reassessment
...
| **Priority** | P1 |
| **MVP** | No |
| **Dependencies** | P-402, A-304 |

## Description

Path Refresh on Reassessment. See development plan roadmap.

## Objective

Hook after assessment submit to regenerate/update learning path if weak topics changed.
...
- `See task — implement as needed for P-405`
...
```
You are a senior full-stack engineer implementing task P-405 for IqbalAI LMS.

Hook after assessment submit to regenerate/update learning path if weak topics changed.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for P-405
