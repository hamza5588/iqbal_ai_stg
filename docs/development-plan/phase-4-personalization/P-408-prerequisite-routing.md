...
| **Priority** | P2 |
| **MVP** | No |
| **Dependencies** | F-001, P-407 |

## Description

Prerequisite Routing. See development plan roadmap.

## Objective

When struggling, insert prerequisite topics into learning path using topic_prerequisites.
...
- `See task — implement as needed for P-408`
...
```
You are a senior full-stack engineer implementing task P-408 for IqbalAI LMS.

When struggling, insert prerequisite topics into learning path using topic_prerequisites.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for P-408
