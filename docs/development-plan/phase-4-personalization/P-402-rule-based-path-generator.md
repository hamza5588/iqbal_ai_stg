# P-402 — Rule-Based Path Generator
...
| **Priority** | P0 |
| **MVP** | Yes |
| **Dependencies** | A-308, P-401 |

## Description

Rule-Based Path Generator. See development plan roadmap.

## Objective

Implement rule-based learning path generation from weak_topics: ordered list of lessons/quizzes/reassessment.
...
- Implement rule-based learning path generation from weak_topics: ordered list of lessons/quizzes/reassessment. MVP deterministic rules.

## Files to Create

- `See task — implement as needed for P-402`
...
```
You are a senior full-stack engineer implementing task P-402 for IqbalAI LMS.

Implement rule-based learning path generation from weak_topics: ordered list of lessons/quizzes/reassessment. MVP deterministic rules.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for P-402
