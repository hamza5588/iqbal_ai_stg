...
Learning Path API. See development plan roadmap.

## Objective

GET/PUT /api/lms/students/me/learning-path — get path, mark item complete.
...
- `See task — implement as needed for P-403`
...
```
You are a senior full-stack engineer implementing task P-403 for IqbalAI LMS.

GET/PUT /api/lms/students/me/learning-path — get path, mark item complete.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for P-403
