...
Learning Path UI. See development plan roadmap.

## Objective

Student dashboard learning path widget: ordered steps, highlight current, completion checkmarks.
...
- `See task — implement as needed for P-404`
...
```
You are a senior full-stack engineer implementing task P-404 for IqbalAI LMS.

Student dashboard learning path widget: ordered steps, highlight current, completion checkmarks.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for P-404
