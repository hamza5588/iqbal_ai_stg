...
| **Priority** | P2 |
| **MVP** | No |
| **Dependencies** | A-332, T-502 |

## Description

PDF Context for Tutor. See development plan roadmap.

## Objective

When quiz is PDF-sourced, include relevant PDF chunks in tutor context.
...
- `See task — implement as needed for T-510`
...
```
You are a senior full-stack engineer implementing task T-510 for IqbalAI LMS.

When quiz is PDF-sourced, include relevant PDF chunks in tutor context.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for T-510
