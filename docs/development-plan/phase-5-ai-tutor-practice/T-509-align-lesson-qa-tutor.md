...
Align Lesson Q&A Tutor. See development plan roadmap.

## Objective

Apply tutor prompt to lesson_qa_graph.
...
- Apply tutor prompt to lesson_qa_graph.py for consistent behavior.

## Files to Create

- `See task — implement as needed for T-509`
...
```
You are a senior full-stack engineer implementing task T-509 for IqbalAI LMS.

Apply tutor prompt to lesson_qa_graph.py for consistent behavior.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for T-509
