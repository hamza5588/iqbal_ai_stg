...
Student Tutor API. See development plan roadmap.

## Objective

POST /api/lms/tutor/chat — extend or wrap existing /chat with tutor mode and LMS context.
...
- `See task — implement as needed for T-503`
...
```
You are a senior full-stack engineer implementing task T-503 for IqbalAI LMS.

POST /api/lms/tutor/chat — extend or wrap existing /chat with tutor mode and LMS context.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for T-503
