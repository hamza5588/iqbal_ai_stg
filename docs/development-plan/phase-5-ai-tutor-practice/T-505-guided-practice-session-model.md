# T-505 — Guided Practice Session Model
...
Guided Practice Session Model. See development plan roadmap.

## Objective

practice_sessions and practice_attempts tables for hint/retry tracking.
...
- `See task — implement as needed for T-505`
...
```
You are a senior full-stack engineer implementing task T-505 for IqbalAI LMS.

practice_sessions and practice_attempts tables for hint/retry tracking.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for T-505
