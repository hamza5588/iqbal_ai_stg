# T-502 — Practice-Aware Tutor Context
...
| **Priority** | P1 |
| **MVP** | No |
| **Dependencies** | T-501, A-304 |

## Description

Practice-Aware Tutor Context. See development plan roadmap.

## Objective

Build context payload: current question, topic, attempt history, mastery for tutor calls.
...
- `See task — implement as needed for T-502`
...
```
You are a senior full-stack engineer implementing task T-502 for IqbalAI LMS.

Build context payload: current question, topic, attempt history, mastery for tutor calls.

BEFORE CODING:
1. Read docs/development-plan/README.md and dependency tasks listed for T-502
