...
- Never put spacing-only TeX (\\,, \\quad) in option text — use a normal space: "(6, 3)" not "(6,\\, 3)".
- Do not duplicate equations into both question.text and question.latex when the stem already includes them.
